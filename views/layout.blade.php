<div class="flex flex-wrap layout"
    x-data='initialize()' :class="{ 'open_sidebar': open_sidebar, 'closed_sidebar': !open_sidebar }">
    ...
    <div class="w-full relative flex z-10">
        ...
        <div class="w-full content z-0 bg-cool-gray-100" x-cloak :class="{'w-4/5 xl:w-5/6': open_sidebar}">
